        ...
        <div className="justify-items-center overflow-hidden md:rounded-md bg-neutral-200 p-3 dark:bg-neutral-950 md:grid md:grid-cols-2 md:gap-24 xl:grid xl:grid-cols-2 xl:gap-x-36">
          ...
          <div className="mb-2 flex flex-col md:w-72 xl:w-96">
            ...
            <div
              ...
              <button
                className="absolute left-2 top-1/2 z-10 flex -translate-y-1/2 transform rounded-full bg-neutral-950 bg-opacity-50 p-2 text-white md:hover:bg-sky-400 md:hover:transition md:hover:duration-500 dark:md:hover:bg-sky-400 dark:md:hover:bg-opacity-50 xl:left-10 2xl:left-0"
              ...
              <figure
                ...
                <img
                  ...
                  className="h-52 rounded-t-lg 2xl:h-64"
                />
              ...
              <button
                className="absolute right-2 top-1/2 flex -translate-y-1/2 transform rounded-full bg-neutral-950 bg-opacity-50 p-2 text-white md:hover:bg-sky-400 md:hover:transition md:hover:duration-500 dark:md:hover:bg-sky-400 dark:md:hover:bg-opacity-50 xl:right-10 2xl:right-0"
            ...
            <div className="mx-5 flex flex-col place-items-center md:mx-2">
              ...
              <div className="flex w-64 flex-col rounded-lg border-2 border-dotted border-sky-400 p-2 dark:border-white sm:align-middle md:w-full 2xl:p-4">
                <p className="font-victorMono text-sm 2xl:text-lg">
                ...
                <p className="font-victorMono text-sm tracking-widest 2xl:text-lg">
