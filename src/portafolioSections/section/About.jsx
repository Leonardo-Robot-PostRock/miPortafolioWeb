...
export const About = () => {
  ...
  return (
    <main
      className="flex h-max min-w-280 place-content-center items-center text-black dark:bg-neutral-900 dark:text-slate-200 md:mb-6 md:h-max xl:h-max 2xl:h-screen"
      id="about">
