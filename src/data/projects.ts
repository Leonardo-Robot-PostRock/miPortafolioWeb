...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    solution: {
      es: 'Lideré la construcción de una aplicación web independiente con Svelte/SvelteKit junto a un equipo de 5 desarrolladores. Implementamos AG Grid para la gestión tabular avanzada de muestras y aplicamos el patrón Mediator para desacoplar la comunicación entre componentes. Coordiné el trabajo del equipo para garantizar la replicación y mejora de todas las funcionalidades de la aplicación de escritorio, resultando en una interface moderna accesible desde cualquier navegador sin necesidad de instalación.',
      en: 'Led the development of a standalone web application with Svelte/SvelteKit alongside a team of 5 developers. We implemented AG Grid for advanced tabular sample management and applied the Mediator pattern to decouple component communication. Coordinated the team to ensure replication and improvement of all desktop app functionalities, resulting in a modern interface accessible from any browser without installation.',
    },
    learnings: [
